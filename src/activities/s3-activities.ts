...
const AWS_URL = process.env.AWS_CONFIG_ENDPOINT;
const AWS_ACCESS_KEY_ID = process.env.AWS_CONFIG_CREDENTIALS_ID;
const AWS_SECRET_ACCESS_KEY = process.env.AWS_CONFIG_CREDENTIALS_KEY;
